...
function svgcircles_func( $atts ){
  return "
  
<div id=\"circles-wrap\">
  <svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width=\"100%\" height=\"360px\" viewBox=\"0 0 603 344\" version=\"1.1\">
...
add_shortcode('svg_circles', 'svgcircles_func');
...
function add_to_footer() {
  global $post;
  /*global $wp_query;
  var_dump((array) $wp_query['queried_object_id']);*/
  $path = "/assets/css/custom/";

  //services
  if (is_home() && !is_front_page()){
    $page_for_posts = get_option( 'page_for_posts' );
    if($page_for_posts == 178){
...
add_action( 'get_footer', 'add_to_footer' );
