...
/*
Plugin Name: Laroche.co #3421137
...
add_action( 'admin_init', array('MyFontsInstaller_3421137','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3421137','mffonts_loadupWebfonts' ));