...
.sharify-container{position:relative;display:block;width:100%;padding:20px 0;overflow:hidden}
.sharify-container ul{padding:0;margin:0}
.sharify-container li{list-style:none;height:55px;width:170px;line-height:36px;float:left;padding-left:2.5px}
.sharify-container li a{border:0;background-color:#00ABF0;border-radius:1px;display:block;font-size:15px;line-height:37px;height:100%;color:#fff;position:relative;text-align:center;text-decoration:none;text-transform:uppercase;width:100%;transition:all .2s ease-in-out}
@media (max-width:955px) and (min-width:769px){.sharify-count{display:none}}@media (max-width:768px){.sharify-count,.sharify-title{display:none}.sharify-icon{width:100%;color:white;padding-left:0!important}.sharify-icon i{text-align:center;}}.sharify-count{float:right}.sharify-container li.sharify-btn-twitter a{background-color: #00ABF0;;}.sharify-container li.sharify-btn-twitter a:hover{background-color:<?php echo get_option('sharify_cph_twitter'); ?>}.sharify-container li.sharify-btn-facebook a{background-color:#5970A6;}.sharify-container li.sharify-btn-facebook a:hover{background-color:#2E3F65;}.sharify-container li.sharify-btn-gplus a{background-color:<?php echo get_option('sharify_cpm_gplus'); ?>;}.sharify-container li.sharify-btn-gplus a:hover{background-color:<?php echo get_option('sharify_cph_gplus'); ?>;}.sharify-container li.sharify-btn-pinterest a{background-color:<?php echo get_option('sharify_cpm_pin'); ?>;}.sharify-container li.sharify-btn-pinterest a:hover{background-color:<?php echo get_option('sharify_cph_pin'); ?>}.sharify-container li.sharify-btn-linkedin a{background-color: #127BB6;}.sharify-container li.sharify-btn-linkedin a:hover{background-color:#124866;}.sharify-container li.sharify-btn-vk a{background-color:<?php echo get_option('sharify_cpm_vk') ?>;}.sharify-container li.sharify-btn-vk a:hover{background-color:<?php echo get_option('sharify_cph_vk') ?>;}.sharify-container li.sharify-btn-reddit a{background-color:<?php echo get_option('sharify_cpm_rdt'); ?>}.sharify-container li.sharify-btn-reddit a:hover{background-color:<?php echo get_option('sharify_cph_rdt'); ?>;}.sharify-container li.sharify-btn-pocket a{background-color:#d3505a}.sharify-container li.sharify-btn-pocket a:hover{background-color:#B6202C}.sharify-container li.sharify-btn-email a{background-color:#191919;}.sharify-container li.sharify-btn-email a:hover{background-color: #363333;); ?>;}
.sharify-container li{margin-bottom: 5px !important; margin-left: 1.5%;}
